...
function advanceSnake(){
	...
	for(var i =0; i < mancare.length;i++){
		if ( head.x === mancare[i].mancareX && head.y === mancare[i].mancareY) {
			score += 1;
...
function drawFood(i){
	...
	ctx.fillRect(mancare[i].mancareX, mancare[i].mancareY, 10, 10);
...
function createFood(){
	...
	mancare.push({"mancareX": mancareX, "mancareY":mancareY});
	var validFood = true;
